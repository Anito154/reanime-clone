//#region src/lib/data/mock.ts
var anilist = (id) => `https://s4.anilist.co/file/anilistcdn/media/anime/cover/medium/${id}`;
var animeList = [
	{
		id: "slime-s4",
		...
		description: "The fourth season of Tensei Shitara Slime Datta Ken. Demon Lord Rimuru's dream of creating an alliance between humans and monsters takes a step closer to being realized. As Tempest continues to prosper, Granville Rozzo and his granddaughter, Maribel Rozzo, clash with Demon Lord Rimuru.",
		rating: 8.1,
		ageRating: "PG-13",
		year: 2026,
		status: "ongoing",
	...
	},
	{
		...
		description: "An Observation Log of My Fiancée Who Calls Herself a Villainess.",
		rating: 7.4,
		ageRating: "PG-13",
		year: 2026,
		status: "ongoing",
	...
	{
		id: "danmachi-iv-p2",
		title: "Is It Wrong to Try to Pick Up Girls in a Dungeon? IV Part 2",
		titleJapanese: "ダンジョンに出会いを求めるのは間違っているだろうかIV 第2クール",
	...
	{
		id: "love-live-bloom",
		title: "Love Live! Hasunosora Jogakuin School Idol Club: Bloom Garden Party",
		titleJapanese: "",
	...
	{
		id: "keroro-movie",
		title: "Shin Keroro Gunsou Movie: Fukkatsushite Sokkou Chikyuu Metsubou no Kiki de Arimasu!",
		titleJapanese: "新・ケロロ軍曹 復活して即行地球滅亡の危機であります！",
...
var latestEpisodes = animeList.filter((a) => a.episodes.length > 0 && a.status !== "upcoming").map((a) => ({
	anime: a,
	latestEpisode: a.episodes[a.episodes.length - 1]
})).sort((a, b) => new Date(b.latestEpisode.aired).getTime() - new Date(a.latestEpisode.aired).getTime());
var newOnSite = [
...
//#endregion
export { newOnSite as a, latestEpisodes as i, continueWatching as n, upcomingAnime as o, getAnimeById as r, animeList as t };
